...
> Última actualización: 2026-03-04 13:01 AST  
> Estado general: **Producción — Motion UI + Legal Modal + Zebra (~96% total)**
...
### ✅ FASE 2G: Motion UI & Visual Polish (COMPLETADO)

| # | Mejora | Tipo | Estado |
|---|---|---|---|
| M-01 | Smart Header — nav hide ↓ / reveal ↑ | Motion | ✅ rAF + `translateY(-100%)` |
| M-02 | Cinematic Reveals — `clip-path: inset()` + scale | Motion | ✅ 1.2s cubic-bezier |
| M-06 | Hero Parallax — video `translateY(scrollY * 0.15)` | Motion | ✅ GPU-composited |
| ZBR | Zebra Backgrounds — `#FFF` / `#F7F7F5` alternados | Visual | ✅ Ritmo visual |
| ADR | Dirección interactiva → Google Maps link | UX | ✅ `hero__label-link` |
| MAP | Google Maps iframe en Footer contacto | UX | ✅ Bordes redondeados + shadow |
| LGL | Legal Modal nativo `<dialog>` (4 secciones) | Feature | ✅ WCAG focus return |
...
FASE 2G: Motion UI & Visual Polish (7)     ████████████████████ 100%
FASE 3:  Assets y Contenido                ██████████████░░░░░░  75%
FASE 4:  Refinamiento UX/Visual            ████████████████████ 100%
